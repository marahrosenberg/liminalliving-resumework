...
A Claude skill that guides any job seeker through a rigorous, structured resume and cover
...
- Anyone who's been told their background "doesn't fit"

---

## What it does

- Deconstructs job descriptions into tiered keyword priorities
- Identifies "the wound" — the organizational problem this hire is meant to solve
- Maps cross-domain experience to role requirements (the non-linear career as asset, not liability)
...
- Runs a full QA checklist before delivery
...
4. Start a conversation — paste a job description or ask for resume help
...
**The nine steps:**
1. JD Deconstruction — keyword tiers, wound identification, gap analysis
2. Experience Mapping — metric hardening, adjacency moves
...
8. QA Checklist — 160-char audit, keyword density, metric density, track alignment
...
This protocol holds both the tactical and the human layer.
